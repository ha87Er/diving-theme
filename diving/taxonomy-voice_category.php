  ...
  <div class="lower-voice layout-lower-voice">
    <div class="lower-voice__inner lower-inner inner">
      <div class="lower-voice__tab-wrap tab-items">
        ...
        ?>
        <?php $voice = get_queried_object();
        $voice_name = $voice -> name; ?>
        <a href="<?php echo esc_url(get_term_link($voice_term, 'voice_category')); ?>" class="tab-items__tab <?php if($voice_name == esc_html($voice_term->name) && !$is_voice_archive) {echo "is-active";} ?>"><?php echo esc_html($voice_term->name); ?></a>
        <?php
        endforeach;
        ?>
      </div>
